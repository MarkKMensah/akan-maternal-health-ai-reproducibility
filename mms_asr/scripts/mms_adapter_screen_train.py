"""Train and evaluate the frozen one-seed MMS maternal-health adapter screen."""
...
PROTOCOL_ID = "mms-maternal-adapter-screen-dev-v1"
SEED = 20260806
...
RUN_ID = "20260806_mms_maternal_adapter_screen_seed20260806"
...
predictions_path = RUN_DIR / "predictions" / "mms_adapter_screen_best_epoch_full_dev_paired.csv"
...
decision_path = RUN_DIR / "MMS_ADAPTER_SCREENING_DECISION.json"
